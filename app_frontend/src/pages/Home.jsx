            ...
            <div className='absolute inset-0 pointer-events-none select-none' style={{ zIndex: 1 }}>
                <div
                    ...
                    style={{
                        ...
                        width: '75%',
                        height: '60%',
                        background: 'radial-gradient(circle at center, rgba(217,169,25,0.09) 0%, rgba(180,130,10,0.03) 40%, transparent 70%)',
                        filter: 'blur(40px)',
                    }}
                />
                <div
                    ...
                    style={{
                        ...
                        width: '110%',
                        height: '70%',
                        background: 'radial-gradient(circle at center, rgba(217,169,25,0.18) 0%, rgba(180,130,10,0.07) 45%, transparent 70%)',
                        filter: 'blur(50px)',
                    }}
                />
            </div>
            ...
            <div className='relative z-10 h-[75vh] w-[90%] sm:w-[85%] md:w-[80%] mx-auto flex justify-center items-center flex-col gap-8 md:gap-10'>
                ...
                <div className='flex flex-col sm:flex-row gap-3 sm:gap-5 w-full sm:w-auto items-center'>
                    <button
                        ...
                        className='w-full sm:w-auto group px-5 py-2.5 bg-[#D9A919] font-medium inline-flex items-center justify-center gap-1 rounded-xl hover:shadow-[0_0_15px_rgba(193,143,19,0.6)] duration-300 hover:-translate-y-0.5 text-black text-base md:text-lg cursor-pointer'
                    >
                        Analyze Your Resume
                    </button>
                    <button
                    ...
                    >
                        ...
                        <span className='relative z-10 flex justify-center items-center gap-1'>
                            Ask about Your Resume <ArrowRight size={18} className='group-hover:translate-x-1 transition-transform duration-300' />
                        </span>
                    </button>
                </div>
            </div>
            ...
            <div className='relative z-10 flex-1 flex items-center justify-center'>
                <div className='flex flex-wrap gap-1.5 md:gap-3 justify-center px-3'>
                    {[
                        ...
                        <div
                            key={full}
                            className='group flex items-center gap-1.5 px-2.5 md:px-4 py-1 md:py-2 rounded-full border border-[#2a2a2a] bg-[#111111] hover:border-[#3a3020] transition-colors duration-300'
                        >
                            <span className='relative w-2 h-2 md:w-3 md:h-3 flex items-center justify-center'>
                                ...
                                <span className='absolute text-[#D9A919] text-[10px] md:text-xs opacity-0 scale-0 rotate-180 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 group-hover:rotate-0'>
                                    ✦
                                </span>
                            </span>
